...
class Category extends Render_Controller
{
    ...
    public function index()
    {
        ...
        $this->breadcrumb_4_url = base_url() . 'product/category';
        // content
        $this->content      = 'admin/product/category';
    ...
    function __construct()
    {
        ...
        $this->load->model("admin/product/CategoryModel", 'model');

...
class Color extends Render_Controller
{

    public function index()
    {
        // Page Settings
        $this->title = 'Warna Produk';
        $this->navigation = ['Warna'];
        ...
        $this->breadcrumb_4 = 'Warna';
        $this->breadcrumb_4_url = base_url() . 'product/color';
        // content
        $this->content      = 'admin/product/color';
    ...
    public function insert()
    {
        ...
        $user_id = $this->id;
        $result = $this->model->insert($user_id, $name, $slug, $foto, $description, $status);
    ...
    public function update()
    {
        ...
        $description = $this->input->post("description");
        $user_id = $this->id;
        $result = $this->model->update($id, $user_id, $name, $slug, $foto, $description, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    function __construct()
    {
        ...
        $this->photo_path = './files/product/color/';
        $this->load->model("admin/product/ColorModel", 'model');

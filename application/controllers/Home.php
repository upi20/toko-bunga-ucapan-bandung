...
class Home extends Render_Controller
{
	...
	public function index()
	{
		...
		// list produk
		$this->data['product_head'] = $this->key_value->get($this->key_product_head);
		$this->data['products'] = $this->model->getProducts();

		// penawaran
		$this->data['offer_head'] = $this->key_value->get($this->key_offer_head);
		$this->data['offer_body'] = $this->key_value->get($this->key_offer_body);

		// penawaran 2
		$this->data['offer_head2'] = $this->key_value->get($this->key_offer_head2);
		$this->data['offer_body2'] = $this->key_value->get($this->key_offer_body2);

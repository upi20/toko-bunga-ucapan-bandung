...
class ColorModel extends Render_Model
{
    ...
    public function insert($user_id, $name, $slug, $foto, $description, $status)
    {
        ...
        // Insert users
        $execute = $this->db->insert('product_colors', $data);
    ...
    public function update($id, $user_id, $name, $slug, $foto, $description, $status)
    {
        ...
        $execute = $this->db->update('product_colors', $data);
        return  $execute;
    }
    ...
    {
        // Delete users
        $exe = $this->db->where('id', $id)->update('product_colors', [
            'status' => 3,
            'deleted_by' => $user_id,
